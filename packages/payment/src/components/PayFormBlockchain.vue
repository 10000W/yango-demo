...
import { BaseStack } from '@tac-crypto-payment/ui'
import { BaseStackItem } from '@tac-crypto-payment/ui'
import { BaseProgressTimer } from '@tac-crypto-payment/ui'
...
const load = async () => {
  ...
  if (selectedPaymentOption.value?.walletName && namespace.value === 'eip155') {
    ...
    walletButton = createWalletButton(namespace.value)
