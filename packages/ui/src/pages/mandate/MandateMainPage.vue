...
import { evmPaymentOptions, type PaymentOption } from '@/entities/payment'
...
import MandateMethodSelectable from '@/components/mandate/MandateMethodSelectable.vue'
