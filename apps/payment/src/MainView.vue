...
import { BaseSpinner, BaseIcon } from '@tac-crypto-payment/ui'
...
const config = inject<PaymentConfig>('tacPaymentUiConfig')!
  ...
  try {
    ...
    await router.replace({
      ...
      query: {
        ...
        message: `We could not initialize the system. Please check your connection and try again.`,
      },
    })
    isLoading.value = false
  }
...
<template>
  <main :class="[$style.viewport, {[$style._glow]: isGlowVisible}]">
